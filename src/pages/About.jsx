    ...
    <div className="about-page container">
      ...
      <section className="about-section">
        ...
        <p>
          ...
          <br />
            - Red Bet with Violet Result (Number 5): Returns x1.395 
          <br />
            - Green Bet with Violet Result (Number 0): Returns x1.395 (half of x1.85)
          <br />
          <br />
          ...
          <li><strong>Payout Structure</strong>
            <ul>
              ...
              <li><strong>Special Payouts:</strong>
                <ul>
                  <li>Red bet with Violet result and number 5: Pays 1.395x.</li>
                  <li>Green bet with Violet result and number 0: Pays 1.395x.</li>
                </ul>
              </li>
            </ul>
          </li>
