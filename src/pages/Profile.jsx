      ...
      <div className="profile-container">
        ...
        <div className="referral-section">
          <h2>
            ...
            <span
              data-tooltip-id="referral-tooltip"
              data-tooltip-content="Invite friends using your unique referral link to earn $50 when they sign up and verify their email."
              className="help-icon"
            >
              ?
            </span>
          ...
          {referralStatsLoading ? (
            <div className="loading-spinner" aria-live="polite">Loading referral stats...</div>
          ) : referralStatsError ? (
            <p className="error" role="alert">{referralStatsError.message}</p>
          ) : (
            <div className="referral-stats">
              <h3>Referral Statistics</h3>
              <p><strong>Total Referrals:</strong> {referralStats?.totalReferrals || 0}</p>
              <p><strong>Rewards Earned:</strong> ${(referralStats?.rewardsEarned || 0).toFixed(2)}</p>
              ...
              <button
                onClick={() => queryClient.invalidateQueries(['referralStats'])}
                className="refresh-stats-button"
                aria-label="Refresh referral statistics"
