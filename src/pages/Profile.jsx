...
// // NEW: API function to bind bank account or crypto wallet
...
//     payload.cryptoCurrency = cryptoCurrency;
//     payload.walletAddress = walletAddress;
//     if (cryptoCurrency === 'USDT' && network) {
//       payload.network = network;
//     }
//   }
//   const response = await fetch(`${API_URL}/api/user/bind-account-wallet`, {
//     method: 'POST',
//     headers: {
//       'Content-Type': 'application/json',
//       Authorization: `Bearer ${token}`,
...
//     const errorData = await response.json().catch(() => ({ error: 'Unknown error' }));
//     if (response.status === 401) throw new Error('Authentication required');
//     throw new Error(errorData.error || `Binding account/wallet failed: ${response.status}`);
//   }
//   return response.json();
// };
...
//   // NEW: State for binding account/wallet modal
//   const [isBindAccountWalletModalOpen, setIsBindAccountWalletModalOpen] = useState(false);
...
//   });
//   // NEW: State for binding form data
...
//   // NEW: Mutation for binding account/wallet
...
//           </button>
//         </div>
//         {/* UPDATED: Changed to Withdrawal Settings with Bind Account/Wallet button */}
//         <div className="withdrawal-password-section">
//           <h2>
//             Withdrawal Settings
//             <span
//               data-tooltip-id="withdrawal-settings-tooltip"
//               data-tooltip-content="Set a secure password and bind your bank account or crypto wallet to facilitate withdrawals."
//               className="help-icon"
//             >
//               ?
//             </span>
//           </h2>
//           <p>Configure your withdrawal password and bind your bank account or crypto wallet for secure transactions.</p>
//           <div className="withdrawal-settings-buttons">
//             <button
...
//             </button>
//             <button
//               onClick={() => setIsBindAccountWalletModalOpen(true)}
//               className="bind-account-wallet-button"
//               aria-label="Bind bank account or crypto wallet"
//               disabled={bindAccountWalletMutation.isLoading}
//             >
//               Bind Account/Wallet
//             </button>
//           </div>
...
//                   {depositData.cryptoCurrency === 'USDT' ? `(${depositData.network})` : ''}
//                 </p>
...
//                   <QRCodeCanvas
//                     value={
//                       depositData.cryptoCurrency === 'BTC'
...
//       {/* NEW: Bind Account/Wallet Modal */}
//       {isBindAccountWalletModalOpen && (
//         <div className="modal-overlay">
//           <div className="modal-content">
//             <button
//               onClick={() => {
...
//               }}
//               className="modal-close"
//               aria-label="Close bind account/wallet modal"
//             >
//               ×
//             </button>
//             <h2>Bind Account/Wallet</h2>
//             <p className="modal-note">
...
//                   if (!bindData.bankCode || !/^\d{3}$/.test(bindData.bankCode)) {
...
//                   id="bind-type"
//                   name="bindType"
//                   value={bindData.bindType}
//                   onChange={(e) =>
//                     setBindData({
//                       ...bindData,
//                       bindType: e.target.value,
//                       bankCode: '',
//                       accountNumber: '',
//                       cryptoCurrency: 'BTC',
//                       walletAddress: '',
...
//                 </select>
//               </div>
//               {bindData.bindType === 'bank' && (
//                 <>
//                   <div className="form-group">
//                     <label htmlFor="bind-bank-code" className="modal-label">
//                       Bank
//                     </label>
//                     <select
//                       id="bind-bank-code"
//                       name="bankCode"
//                       value={bindData.bankCode}
//                       onChange={(e) => setBindData({ ...bindData, bankCode: e.target.value })}
//                       className="modal-input"
//                       disabled={bindAccountWalletMutation.isLoading}
//                     >
//                       <option value="">Select Bank</option>
...
//                   </div>
//                   <div className="form-group">
//                     <label htmlFor="bind-account-number" className="modal-label">
//                       Account Number
//                     </label>
//                     <input
//                       id="bind-account-number"
//                       type="text"
//                       value={bindData.accountNumber}
//                       onChange={(e) => setBindData({ ...bindData, accountNumber: e.target.value })}
//                       className="modal-input"
//                       placeholder="Enter 10-digit account number"
//                       disabled={bindAccountWalletMutation.isLoading}
//                     />
...
//                 </>
//               )}
//               {bindData.bindType === 'crypto' && (
//                 <>
//                   <div className="form-group">
//                     <label htmlFor="bind-crypto-currency" className="modal-label">
//                       Cryptocurrency
//                     </label>
//                     <select
//                       id="bind-crypto-currency"
//                       name="cryptoCurrency"
//                       value={bindData.cryptoCurrency}
//                       onChange={(e) =>
//                         setBindData({
//                           ...bindData,
//                           cryptoCurrency: e.target.value,
...
//                     </select>
//                   </div>
//                   {bindData.cryptoCurrency === 'USDT' && (
//                     <div className="form-group">
//                       <label htmlFor="bind-network" className="modal-label">
//                         Network
//                         <span
//                           data-tooltip-id="network-tooltip"
//                           data-tooltip-content="Select the blockchain network for USDT (BEP20 for Binance Smart Chain, ARBITRUM for Arbitrum, TON for The Open Network)."
//                           className="help-icon"
//                         >
//                           ?
//                         </span>
...
//                         id="bind-network"
//                         name="network"
//                         value={bindData.network}
//                         onChange={(e) => setBindData({ ...bindData, network: e.target.value })}
//                         className="modal-input"
//                         disabled={bindAccountWalletMutation.isLoading}
//                       >
//                         <option value="BEP20">BEP20 (Binance Smart Chain)</option>
...
//                   )}
//                   <div className="form-group">
//                     <label htmlFor="bind-wallet-address" className="modal-label">
//                       Wallet Address
//                     </label>
//                     <input
//                       id="bind-wallet-address"
//                       type="text"
//                       value={bindData.walletAddress}
//                       onChange={(e) => setBindData({ ...bindData, walletAddress: e.target.value })}
//                       className="modal-input"
//                       placeholder="Enter your wallet address"
//                       disabled={bindAccountWalletMutation.isLoading}
//                     />
...
//                 </>
//               )}
//               {errors.bindAccountWallet && <p className="modal-error">{errors.bindAccountWallet}</p>}
//               <button
//                 type="submit"
//                 className="modal-submit"
//                 disabled={bindAccountWalletMutation.isLoading}
...
//       {/* UPDATED: Changed tooltip ID */}
//       <Tooltip id="withdrawal-settings-tooltip" place="top" variant="dark" />
...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setErrors({ profile: err.response?.data?.error || 'Failed to fetch profile' });
      }
    };
    fetchProfile();
  }, [token]);

  // Prefill withdrawal form when modal opens or currency changes
  useEffect(() => {
    if (showWithdrawModal && user) {
      setWithdrawData((prev) => ({
        ...
        amount: '',
        withdrawalPassword: '',
        // Prefill based on currency and bound details
        ...
        ...(prev.currency === 'crypto' && user.boundWallet
          ? {
              cryptoCurrency: user.boundWallet.cryptoCurrency || '',
              walletAddress: user.boundWallet.walletAddress || '',
              network: user.boundWallet.network || '',
            }
          : {}),
      }));
    }
  }, [showWithdrawModal, withdrawData.currency, user]);
  ...
  const validateWithdrawData = () => {
    ...
    } else if (withdrawData.amount < 1500) {
      newErrors.amount = 'Minimum withdrawal amount is ₦1,500';
    }
    if (!withdrawData.withdrawalPassword) {
      newErrors.withdrawalPassword = 'Withdrawal password is required';
    }
    if (withdrawData.currency === 'NGN' && !user?.boundBank) {
      if (!withdrawData.bankCode) newErrors.bankCode = 'Bank is required';
      if (!/^\d{10}$/.test(withdrawData.accountNumber)) {
        newErrors.accountNumber = 'Account number must be 10 digits';
      }
    }
    if (withdrawData.currency === 'crypto' && !user?.boundWallet) {
      if (!withdrawData.cryptoCurrency) newErrors.cryptoCurrency = 'Cryptocurrency is required';
      if (!withdrawData.walletAddress) newErrors.walletAddress = 'Wallet address is required';
      if (withdrawData.cryptoCurrency === 'USDT' && !withdrawData.network) {
        newErrors.network = 'Network is required for USDT';
      }
    }
    setErrors(newErrors);
  ...
  const handleWithdrawSubmit = async (e) => {
    e.preventDefault();
    if (!validateWithdrawData()) return;

    try {
      const endpoint =
        withdrawData.currency === 'NGN'
          ? '/api/transactions/paystack-withdrawal'
          : '/api/transactions/crypto-withdrawal';
      ...
      setErrors({ withdraw: err.response?.data?.error || 'Withdrawal failed' });
    }
  };
  ...
  return (
    <div className="profile-page">
      <h1>Profile</h1>
      {errors.profile && <div className="profile-error">{errors.profile}</div>}
      {user && (
        <div className="profile-container">
          <div className="profile-info">
            <h2>User Information</h2>
          ...
          <div className="profile-button-group">
            <button className="withdraw-button" onClick={openWithdrawModal}>
              Withdraw
            </button>
            {/* Other buttons, e.g., Bind Account/Wallet */}
          </div>
        </div>
      )}
      ...
      {showWithdrawModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            <button className="modal-close" onClick={closeWithdrawModal}>
              ×
            </button>
            <h2>Withdraw Funds</h2>
            <form onSubmit={handleWithdrawSubmit}>
              <div className="form-group">
                ...
                <select
                  ...
                  className="modal-input"
                >
                  <option value="NGN">NGN (Bank)</option>
              ...
              {withdrawData.currency === 'NGN' ? (
                <>
                  {user?.boundBank ? (
                    <p className="modal-note">
                      Using bound bank: {user.boundBank.bankName} ({user.boundBank.accountNumber})
                    </p>
                  ) : (
                    <>
                      <div className="form-group">
                        ...
                        {errors.bankCode && <span className="modal-error">{errors.bankCode}</span>}
                      </div>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          className="modal-input"
                        />
                        {errors.accountNumber && <span className="modal-error">{errors.accountNumber}</span>}
                      </div>
                    </>
                  )}
                </>
                ...
                <>
                  {user?.boundWallet ? (
                    ...
                    <>
                      <div className="form-group">
                        <label className="modal-label">Cryptocurrency</label>
                        <select
                          name="cryptoCurrency"
                          value={withdrawData.cryptoCurrency}
                          onChange={handleWithdrawChange}
                        ...
                        {errors.cryptoCurrency && <span className="modal-error">{errors.cryptoCurrency}</span>}
                      </div>
                      {withdrawData.cryptoCurrency === 'USDT' && (
                        <div className="form-group">
                          <label className="modal-label">Network</label>
                          <select
                            name="network"
                            value={withdrawData.network}
                            onChange={handleWithdrawChange}
                          ...
                          {errors.network && <span className="modal-error">{errors.network}</span>}
                        </div>
                      )}
                      <div className="form-group">
                        ...
                        <input
                          ...
                          className="modal-input"
                        />
                        {errors.walletAddress && <span className="modal-error">{errors.walletAddress}</span>}
                      </div>
                    </>
                  )}
                </>
              ...
              <div className="form-group">
                <label className="modal-label">Withdrawal Password</label>
                <input
                  type="password"
                  ...
                  className="modal-input"
                />
                {errors.withdrawalPassword && <span className="modal-error">{errors.withdrawalPassword}</span>}
              </div>
              {errors.withdraw && <div className="modal-error">{errors.withdraw}</div>}
